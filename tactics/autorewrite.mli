...
val autorewrite : ?conds:conditions -> bool -> unit Proofview.tactic -> string list -> unit Proofview.tactic
val autorewrite_in : ?conds:conditions -> bool -> Names.Id.t -> unit Proofview.tactic -> string list -> unit Proofview.tactic
...
val auto_multi_rewrite : ?conds:conditions -> bool -> string list -> Locus.clause -> unit Proofview.tactic

val auto_multi_rewrite_with : ?conds:conditions -> bool -> unit Proofview.tactic -> string list -> Locus.clause -> unit Proofview.tactic
